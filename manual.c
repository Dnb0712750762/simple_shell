...
.\"Created by Rosita Jose Uqueio and Nyiko Danny Baloyi
.TH HSH 1 "2022" "ALX Africa" "SHELL - Simple Shell man page"
...
.SH COPYRIGHT
hsh is Copyright (C) 2022 by Rosita jose uqueio and Nyiko Danny Baloyi
...
.SH AUTHORS
Rosita Jose Uqueio and Nyiko Danny Baloyi
